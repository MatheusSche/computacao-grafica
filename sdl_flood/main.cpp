...
int main()
{
     ...
     while (1)
    {
        ...
        bresenham_line((width-1)/2, 0, (width-1)/2, height-1);
        // horizontal central line
		bresenham_line(0, (height-1)/2, width-1, (height-1)/2);
        // top line
		...
		floodFill(177, 139, RGB(8,112,247), 0);
		floodFill(441, 345, RGB(8,247,16), 0);
		floodFill(499, 92, RGB(247,200,8), 0);
		floodFill(124, 293, RGB(255,0,0), 0);
